...
SOURCES       = main.cpp \
		...
		player.cpp \
		lyricsmanager.cpp \
		equalizerwindow.cpp qrc_resources.cpp \
		moc_mainwindow.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h playlistmodel.h player.h lyricsmanager.h equalizerwindow.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp playlistmodel.cpp player.cpp lyricsmanager.cpp equalizerwindow.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_playlistmodel.cpp moc_player.cpp moc_lyricsmanager.cpp moc_equalizerwindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_playlistmodel.cpp moc_player.cpp moc_lyricsmanager.cpp moc_equalizerwindow.cpp
